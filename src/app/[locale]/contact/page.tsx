        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="name" className="block mb-2">{t("form.name")}</label>
                <input
                  type="text"
                  id="name"
                  name="name"
              ...
              <div>
                <label htmlFor="email" className="block mb-2">{t("form.email")}</label>
                <input
                  type="email"
                  id="email"
                  name="email"
              ...
              <div>
                <label htmlFor="message" className="block mb-2">{t("form.message")}</label>
                <textarea
                  id="message"
                  name="message"
          ...
          <motion.div
            ...
            className="space-y-8"
          >
            <h2 className="text-3xl font-semibold mb-6">{t("info.title")}</h2>
