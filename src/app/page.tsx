...
//       {/* bg-gradient-to-b from-purple-600 via-pink-500 to-red-500 */}
//      < Header />
...
//     <>
//       <Head>
//         <title>AI Services - Marketorix</title>
//         <meta
//           name="description"
//           content="Discover Marketorix's comprehensive AI services, including strategy formulation, custom solutions, chatbot development, and more. Tailored AI solutions to help your business grow."
//         />
//         <meta
//           name="keywords"
//           content="AI services, AI strategy, chatbot development, custom AI solutions, AI integration"
//         />
//       </Head>
//       <div className="bg-gradient-to-b from-purple-600 via-pink-500 to-red-500 text-white min-h-screen flex flex-col ">
//         <Header />
...
//                   animate={{ opacity: 1, y: 0 }}
//                   transition={{ duration: 0.5, delay: index * 0.1 }} // Delay based on the index
//                   className="bg-white bg-opacity-10 backdrop-blur-lg rounded-lg p-6 hover:bg-opacity-20 transition-all transform hover:scale-105"
//                 >
//                   <h3 className="text-xl font-semibold mb-4">{service.title}</h3>
